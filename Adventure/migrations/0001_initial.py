# Generated by Django 3.1.2 on 2022-04-19 20:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(default='No Specific Location', max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('audiofile', models.FileField(upload_to='audio', validators=[Adventure.models.validate_audio_extension])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.TextField(default='Enter message here', max_length=5000)),
                ('success_message', models.TextField(default='Enter message to be displayed on successful entry of answer', max_length=5000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('videofile', models.FileField(upload_to='video', validators=[Adventure.models.validate_video_extension])),
                ('name', models.CharField(max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('imagefile', models.FileField(upload_to='images', validators=[Adventure.models.validate_image_extension])),
                ('name', models.CharField(max_length=100)),
                ('clue', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_query_name='clue', to='Adventure.clue')),
            ],
        ),
        ...
        migrations.AddConstraint(
            model_name='map',
            constraint=models.UniqueConstraint(fields=('lat', 'lng', 'clue'), name='map_unique_constraint'),
        ),
        migrations.AddConstraint(
            model_name='image',
